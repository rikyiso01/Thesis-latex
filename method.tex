This chapter describes the core of your work: the methodology you used
...
(\Cref{sec:background}), and the results that you will show in the
Results chapter (\Cref{sec:results}). Put abundant references to help
...
(\Cref{sec:background}), or make it very clear that you are not the
...
\myhref{https://www.overleaf.com/learn/latex/Algorithms}{relevant \latex packages}
for that.
